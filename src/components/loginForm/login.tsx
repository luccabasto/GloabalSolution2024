    ...
    <div>
      ...
      <form onSubmit={handleLogin}>
        <div className='relative mb-8'data-twe-input-wrapper-init>
          ...
          className='peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none text-intenseBlue  :placeholder:opacity-0' placeholder='Usuário' />
